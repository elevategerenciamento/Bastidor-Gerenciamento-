                  ...
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="py-1 md:py-2">
                      <span className="text-3xl md:text-4xl font-serif font-black text-vinho">
                        {billingPeriod === 'monthly' ? 'R$ 24,90' : 'R$ 289,90'}
                      </span>
                      <span className="text-xs text-cinza font-bold">
                        {billingPeriod === 'monthly' ? ' / mês' : ' / ano'}
                      </span>
                      {billingPeriod === 'yearly' && (
                        <div className="text-[10px] text-dourado font-bold mt-1">Equivalente a R$ 24,15/mês</div>
                      )}
                    </div>
                  ...
                  <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="py-1 md:py-2">
                      <span className="text-3xl md:text-4xl font-serif font-black text-creme">
                        {billingPeriod === 'monthly' ? 'R$ 44,90' : 'R$ 529,90'}
                      </span>
                      <span className="text-xs text-rosa/60 font-bold">
                        {billingPeriod === 'monthly' ? ' / mês' : ' / ano'}
                      </span>
                      {billingPeriod === 'yearly' && (
                        <div className="text-[10px] text-dourado font-bold mt-1">Equivalente a R$ 44,15/mês</div>
                      )}
                    </div>
